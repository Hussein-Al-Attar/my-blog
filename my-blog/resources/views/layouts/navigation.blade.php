<nav>
    ...
    <a class="@if (request()->routeIs('book.index')) active @endif" href="{{ route('book.index') }}">
    ...
    <a class="@if (request()->routeIs('book.create')) active @endif" id="mylink" href="{{ route('book.create') }}">
    ...
    <a class="@if (request()->routeIs('Sreach.index')) active @endif" href="{{ route('Sreach.index') }}">
        <svg viewBox="0 0 100 100">
            <g transform="translate(5 5) scale(0.9 0.9)">
                <circle cx="45" cy="38" r="38" stroke="currentColor" stroke-width="10" fill="none" />
                <line x1="66" y1="65" x2="100" y2="100" stroke="currentColor"
                    stroke-width="10" />
            </g>
        </svg>
        <span>
    ...
    @if (Auth::user()->can('supervise'))
    <a class="@if (request()->routeIs('supervise.index')) active @endif" href="{{ route('supervise.index') }}">
